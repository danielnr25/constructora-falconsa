<x-layouts.app title="Dashboard">
    ...
    <div class="bg-white shadow-md rounded-md px-5 py-4">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-xl font-semibold my-4">Registrar Obras</h1>
            <div>
            ...
            <form action="{{ route('admin.jobs.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="subtitle" id="subtitle" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm rounded-md @error('subtitle') border-red-500 @enderror" value="{{ old('subtitle') }}">
                        @error('subtitle')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        <label for="location" class="block text-sm font-semibold text-gray-800 tracking-wide">Lugar de la obra</label>
                        <input type="text" name="location" id="location" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm @error('title') border-red-500 @enderror rounded-md" value="{{ old('location') }}">
                        @error('location')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        <label for="client" class="block text-sm font-semibold text-gray-800 tracking-wide">Cliente / Empresa</label>
                        <input type="text" name="client" id="client" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm @error('title') border-red-500 @enderror rounded-md" value="{{ old('client') }}">
                        @error('client')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        <label for="year" class="block text-sm font-semibold text-gray-800 tracking-wide">Año de la obra</label>
                        <input type="text" name="year" id="year" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm @error('title') border-red-500 @enderror rounded-md" value="{{ old('year') }}">
                        @error('year')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
