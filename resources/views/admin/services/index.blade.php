<x-layouts.app title="Dashboard">
    ...
    <div class="bg-white shadow-md rounded-md px-5 py-4">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-xl font-semibold my-4">Listado de servicios</h1>
            <div>
                <a href="{{ route('admin.services.create') }}" class="bg-gray-900 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-md">
                    Crear servicio
                </a>
            </div>
        </div>
                        ...
                        <tr class="bg-white border-b text-gray-900">
                            ...
                            <th class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <span style="display: inline-block;
                                    ...
                                    text-overflow: ellipsis;"> {{ $service->title }}
                                </span>
                            </th>
                            <td class="px-6 py-4">
                                <img class="h-auto object-cover max-w-[60px]" src="/uploads/{{$service->imagen }}" alt="image-none">
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-3 items-center">
                                    <a href="{{ route('admin.services.edit', $service->id ) }}" class="font-medium bg-emerald-700 px-2 py-1 rounded-md text-white hover:bg-green-500">Editar</a>
