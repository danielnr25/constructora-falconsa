<x-layouts.app title="Dashboard">
    ...
    <div class="bg-white shadow-md rounded-md px-5 py-4">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-xl font-semibold my-4">Registrar Post</h1>
            <div>
            ...
            <form action="{{ route('admin.posts.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="excerpt" id="excerpt" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm @error('title') border-red-500 @enderror rounded-md" value="{{ old('excerpt') }}">
                        @error('excerpt')
                        <div class=" text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
