<form action="#" method="POST" class="px-6 pb-10 pt-5 sm:pb-20 lg:px-8 lg:py-20">
    <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
        ...
        <div class="mt-8 flex justify-end">
            <button type="submit" class="rounded-md bg-blue-700 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700">
                Enviar mensaje
            </button>
        </div>
    </div>
