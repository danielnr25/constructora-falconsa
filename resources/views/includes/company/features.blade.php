<main class="py-3">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 py-10 px-10 lg:px-20">
        <div class="col-span-12 lg:col-span-6">
            <img src="{{ asset('dist/img/empresa/empresa.webp') }}" alt="empresa" class="w-full object-cover rounded-lg shadow-blue-100" />
        </div>

        <div class="col-span-12 lg:col-span-6 flex flex-col justify-center">
            <h1 class="font-circular-medium lg:text-2xl text-xl mb-6 text-gray-800 tracking-wider">
                SOLUCIONES INTEGRALES EN PROYECTOS INMOBILIARIOS EN CHICLAYO
            </h1>
            <p class="text-gray-800 text-justify text-[17px]  leading-8 mb-6">
            ...
            <div>
                <button class="uppercase bg-blue-700 py-2 px-4 rounded-lg text-white hover:bg-blue-800">
                    Descargar broshure
                </button>
            </div>
        </div>
    ...
    <div class="py-10 px-10 lg:px-20">
        <dl class="grid max-w-2xl grid-cols-1 gap-x-8 gap-y-12 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <div class="bg-white py-5 px-5 rounded-lg shadow-lg">
                ...
                <dd class="mt-4 text-base leading-7 text-gray-800 text-justify">
                    Somos una empresa constructora en Chiclayo especializada en prestar servicios integrales para la ejecución de proyectos inmobiliarios en Chiclayo. Entre nuestros servicios se encuentran: ejecución de obras de ingeniería civil, demoliciones, elaboración y ejecución de proyectos de construcción y la supervisión en general.
                </dd>
            </div>
            <div class="bg-white py-5 px-5 rounded-lg shadow-lg">
                <dt class="text-lg lg:text-xl text-center font-circular-medium  leading-6 text-indigo-900 uppercase">
                ...
                <dd class="mt-4 text-base leading-7 text-gray-800 text-justify">
                    CONSTRUCTORA FALCONSA S.A es mucho más que una simple empresa constructora. Desde el principio, contribuimos y nos implicamos con el desarrollo social del Perú, así como respetamos tanto la normativa referente a los temas de seguridad lo cual nos obliga a optar por brindarles seriedad y garantía con el Proyecto por realizar.
                </dd>
            </div>
        </dl>
    </div>
